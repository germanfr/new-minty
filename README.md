...
* __Make a symlink of the `New-Minty` folder inside the `~/.themes` dir.__
    ...
    * __NOTE:__ If you already have a folder/file name `New-Minty` in your `.themes` dir, it will be __deleted__.
